...
<div id="MessageDiv" class="MessageDiv">
    ...
    <a class="buttonDD" href="http://localhost:8080/message/login.jsp" style="width: 40%;margin-left: 10px;margin-top:20px">查看留言历史</a>
    <div id="user" style="margin-left: 15px;margin-top: 30px">
        <div class="DivU">用户名 :<%=user.getName() %></div> <br>
        <div class="DivU">已留言 :<%= times%></div> <br>
    </div>
    <form method="get" action="/message/AddMessage">
...
<script type="text/javascript">
    function fun() {
       ...
       %>
        window.open("http://localhost:8080/message/login1.jsp");
    }
</script>
</body>
</html>
